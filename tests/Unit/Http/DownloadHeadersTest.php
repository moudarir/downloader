...
final class DownloadHeadersTest extends TestCase
{
    ...
    public function testItSetsAttachmentDispositionByDefault(): void
    {
        ...
        $headers->addContentDispositionHeader(
            'video.mp4'
        );
    ...
    public function testItAddsContentRangeHeader(): void
    {
        ...
        $headers->addContentRangeHeader(
            'bytes 0-99/1000'
        );

        self::assertSame(
            'bytes 0-99/1000',
            $headers->all()['Content-Range']
        );
    }
    ...
    public function testItAddsDefaultCacheControl(): void
    {
        ...
        self::assertSame(
            DownloadConfig::DEFAULT_CACHE_CONTROL,
            $headers->all()['Cache-Control']
        );
    }
